...
export default function Privacidad() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>Al comprar una entrada:</strong> tu nombre, tu teléfono y, solo si nos lo das, tu email; la noche y el tipo de entrada; el importe, el número de pedido, el estado del pago y su fecha.</li>
        <li><strong>Del pago con tarjeta:</strong> no recibimos ni guardamos el número de tu tarjeta. El pago se hace en la pasarela segura de Redsys, de la entidad financiera de {LEGAL.tradeName}. A nosotros solo nos llega el resultado (autorizado o denegado), el importe, el número de pedido y el código de autorización.</li>
      ...
      <ul>
        ...
        <li><strong>Redsys y la entidad financiera del comercio</strong>, que procesan el pago con tarjeta y son responsables de los datos de tu tarjeta según su propia política.</li>
      </ul>
      ...
      <p>Nuestros servidores están en la Unión Europea. Algunos proveedores (por ejemplo, Supabase Inc.) tienen su matriz en Estados Unidos; en ese caso, el acceso a los datos se ampara en las garantías previstas por el RGPD (cláusulas contractuales tipo o el Marco de Privacidad de Datos UE-EE. UU.). Si pulsas «Ver mapa» en la web, tu navegador se conecta con Google (más información en la <a href="/cookies">Política de cookies</a>).</p>
