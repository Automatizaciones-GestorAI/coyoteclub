...
export default function Cookies() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>Google Maps.</strong> El mapa de «Cómo llegar» <strong>no se carga hasta que pulsas «Ver mapa»</strong>. En ese momento tu navegador se conecta con Google, que puede instalar sus propias cookies e identificarte según su política (<a href="https://policies.google.com/technologies/cookies" target="_blank" rel="noopener">policies.google.com</a>). Si no pulsas el botón, no se envía nada a Google. También puedes abrir la ubicación en la aplicación de Google Maps con el botón «Abrir en Google Maps».</li>
        <li><strong>Redsys (pasarela de pago).</strong> Al pagar, te llevamos a la página segura de Redsys, que puede usar sus propias cookies técnicas y de seguridad para procesar el pago. Se rigen por la política de Redsys y de tu banco.</li>
